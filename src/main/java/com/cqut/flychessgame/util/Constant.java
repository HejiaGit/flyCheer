...
public class Constant {
     ...
     * 开始录音图标
     */
    public static final String BTN_START ="/res/image/other/btn_start.png";

    /**
     * 结束录音图标
     */
    public static final String BTN_STOP = "/res/image/other/btn_stop.png";
     ...
     * 红色飞机出发点坐标
     */
    public static final Point RED_LAUNCH = new Point(92,550) ;

    /**
     * 黄色飞机出发点坐标
     */
    public static final Point YELLOW_LAUNCH = new Point(-1,193) ;

    /**
     * 绿色飞机出发点坐标
     */
    public static final Point GREEN_LAUNCH = new Point(356,101) ;

    /**
     * 蓝色飞机出发点坐标
     */
    public static final Point BLUE_LAUNCH = new Point(447,458) ;
